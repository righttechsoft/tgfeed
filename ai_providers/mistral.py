"""Mistral AI provider for content summarization."""
...
class MistralProvider(AIProvider):
    """Mistral API provider for generating content summaries."""
    ...
    def generate_summary(self, message_text: str, max_retries: int = 3) -> str | None:
        """Generate keywords from message text using Mistral API.
        ...
        logger.error(f"Mistral API failed after {max_retries} retries (rate limited)")
        return None
